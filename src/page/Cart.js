      ...
      <Container style={{backgroundColor: '#fdfdfd'}}>
          ...
          {this.state.cartItems.length <=0 ?
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
              <Icon name='shopping-cart' type='font-awesome' size={38} style={{fontSize: 38, color: '#95a5a6', marginBottom: 7}} />
              ...
              <Grid style={{marginTop: 20, marginBottom: 10}}>
                ...
                <Col style={{paddingLeft: 5, paddingRight: 10}}>
                  <Button onPress={() => this.removeAllPressed()} style={{borderWidth: 1, borderColor: Colors.navbarBackgroundColor}} block iconRight transparent>
                    <Text style={{color: Colors.navbarBackgroundColo}}>Emtpy Cart</Text>
                    <Icon style={{color: Colors.navbarBackgroundColo}} name='trash' type='font-awesome' />
                  </Button>
                </Col>
              </Grid>
            </Content>
        ...
        >
          ...
          <Right>
            <Button style={{marginLeft: -25}} transparent onPress={() => this.removeItemPressed(item)}>
              <Icon size={30} style={{fontSize: 30, color: '#95a5a6'}} name='remove' type='font-awesome' />
            </Button>
          </Right>
        </ListItem>
      );
