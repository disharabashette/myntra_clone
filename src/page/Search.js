...
import { Container, Content, View, Header, Body, Item, Input, Thumbnail, Button, Right, Grid, Col } from 'native-base';
        ...
        >
            <Item>
              <Button transparent onPress={() => Actions.pop()}>
                <Icon name="close" type='ant-design'  size={32} style={{fontSize: 32}} />
              </Button>
              <Input
                placeholder="Search..."
                ...
                style={{marginTop: 9}}
              />
              <Icon name='search'type= 'feather' onPress={() => this.search(this.state.searchText)} />
            </Item>
          </Header>
          {this.state.items.length <=0 ?
            <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
              <Icon name='search'type= 'feather' size={38} style={{fontSize: 38, color: '#95a5a6', marginBottom: 7}} />
