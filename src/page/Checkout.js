...
import { Container, Content, View, Grid, Col, Left, Right, Button, List, ListItem, Body, Radio, Input, Item } from 'native-base';
        ...
        <Content padder>
          <TouchableHighlight onPress={() => Actions.login()}>
            <View style={{flex: 1, alignItems: 'center', backgroundColor: '#6fafc4', paddingTop: 20, paddingBottom: 20}}>
                <Icon name="warning" type='entypo' style={{color: 'rgba(253, 253, 253, 0.9)', marginRight: 20, position: 'absolute', left: 11, top: 15, borderRightWidth: 1, borderColor: 'rgba(253, 253, 253, 0.2)', paddingRight: 10}}/>
          ...
          <View>
            ...
            <ListItem style={{borderWidth: 1, borderColor: 'rgba(149, 165, 166, 0.3)', paddingLeft: 10, marginLeft: 0}}>
              ...
              <FAIcon name="cc-mastercard" type='font-awesome' size={20} color="#c0392b" style={{marginLeft: 7}} />
              <FAIcon name="cc-visa" type='font-awesome' size={20} color="#2980b9" style={{marginLeft: 2}} />
              <Right>
            ...
            <ListItem style={{borderWidth: 1, borderColor: 'rgba(149, 165, 166, 0.3)', paddingLeft: 10, marginLeft: 0, borderTopWidth: 0}}>
              ...
              <FAIcon name="paypal" type='entypo' size={20} color="#34495e" style={{marginLeft: 7}} />
              <Right>
